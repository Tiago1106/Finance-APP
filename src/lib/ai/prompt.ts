...
6b. Pedido explícito para criar/cadastrar uma categoria (ex: "cria categoria Pets", "cadastra categoria Viagem com orçamento de 500") → create_category, com "name" e "monthly_budget" (null se não mencionar orçamento). Diferente de category_name dentro de add_expense/add_installment/add_recurring, que é só uma proposta de categorização — nunca use create_category para isso.
